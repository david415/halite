...
def printC ( typeDb = None, mustacheFile = None ) :
    ...
    for name, info in typeDb.items() :
        ...
        for field in info.getFixed( ) :
            if field.isComposite( ):
                type_function_set['set_field_composite_fixed'] = getFieldDict( name, currentOffset, field, varIndex )
                currentOffset += type_function_set['set_field_composite_fixed']['width']
            else:
                type_function_set['set_field_fixed'] = getFieldDict( name, currentOffset, field, varIndex )
                currentOffset += type_function_set['set_field_fixed']['width']
